...
namespace OpenIM.IMSDK
{
    ...
    public partial class IMSDK
    {
        ...
        public void DispatorMsg(MessageDef id, string msg)
        {
            switch (id)
            {
        ...
        private void DispatorActiveCallMsg(ActiveCallResult res)
        {
        ...
        private object ConvertDataType(ActiveCallResult res)
        {
