...
namespace IMDemo.UI
{
    public class FriendApplicationListWindow : ImGuiWindow
    {
        ...
        {
            IMSDK.GetInstance().GetFriendApplicationListAsApplicant((list, err, errMsg) =>
            {
                if (list != null)
                {
                    applicantList = list;
        ...
        {
            IMSDK.GetInstance().GetFriendApplicationListAsRecipient((list, err, errMsg) =>
            {
                if (list != null)
                {
                    recipientList = list;
        ...
        {
            IMSDK.GetInstance().AcceptFriendApplication((suc, err, errMsg) =>
            {
                if (suc)
                {
                    RefreshRecipientList();
        ...
        {
            IMSDK.GetInstance().RefuseFriendApplication((suc, err, errMsg) =>
            {
                if (suc)
                {
                    RefreshRecipientList();
