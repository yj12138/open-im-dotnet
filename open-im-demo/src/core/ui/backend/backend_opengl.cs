...
namespace IMDemo.Core.UI.BackEnd
{
    public class ImGuiBackendOpenGL : ImGuiBackEnd
    {
        ...
        public ImGuiBackendOpenGL() : base()
        {
            ...
            // io.Fonts.AddFontFromFileTTF("./res/fonts/SC-Bold.otf", 16, new ImFontConfigPtr
            // {
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        public override void OnEndFrame(float dt)
        {
            base.OnEndFrame(dt);
